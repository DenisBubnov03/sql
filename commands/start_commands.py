...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Ограниченное меню для not_admin
        ...
        reply_keyboard = [['Добавить студента', 'Подписание договора', 'Поиск ученика', 'Статистика', 'Редактировать данные студента', 'Доп расходы', 'Договор']]
    else:
        reply_keyboard = [
            ...
            ['💼 Добавить КК', 'Договор']  # Добавляем кнопки для управления КК и формирования договоров
        ]
...
async def exit_to_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Ограниченное меню для not_admin
        ...
        reply_keyboard = [
            ...
            ['Редактировать данные студента', 'Проверить уведомления'],
            ['Поиск ученика', 'Статистика', "📊 Рассчитать зарплату", 'Доп расходы'],
            ['💼 Добавить КК', 'Договор']  # Добавляем кнопки для управления КК
        ]
